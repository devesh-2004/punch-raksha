...
export default function DashboardAddresses() {
  ...
  const validate = () => {
    ...
    else if (pincodeLookupLoading) errs.pincode = "Detecting city/state, please wait...";
    else if (!form.city.trim() || !form.state.trim()) errs.pincode = pincodeLookupError || "Couldn't detect city/state for this pincode";
    return errs;
  };
  ...
  if (modal) {
    return (
      <div className="bg-[#E6F7F4] w-full pl-[20px] pr-[15px] py-[30px] lg:px-[60px] lg:py-[45px] font-outfit shadow-sm h-full min-h-[400px]">
        <div className="max-w-[1100px]">
          ...
          <div className="mt-[30px] flex flex-col lg:flex-row lg:items-center gap-[20px]">
            ...
            <div className="flex items-center gap-[15px]">
              <button
                onClick={handleSave}
                disabled={saving || pincodeLookupLoading}
              ...
              >
                {saving ? "SAVING..." : pincodeLookupLoading ? "DETECTING..." : "SAVE"}
              </button>
              <button
  ...
  return (
    <div className="bg-[#E6F7F4] w-full pl-[20px] pr-[15px] py-[30px] lg:p-[60px] font-outfit shadow-sm h-full min-h-[400px] flex flex-col justify-between">
      <div>
