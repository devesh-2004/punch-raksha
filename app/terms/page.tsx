      ...
      <div className="mx-auto max-w-[1920px] px-4 lg:px-[50px] py-[40px] md:py-[45px]">
        ...
        <div className="max-w-[1200px] space-y-10 font-outfit text-[#121212]">
          ...
          <div className="space-y-[20px]">
            ...
            <p className="txt-p">
              Customers should always consult a qualified medical doctor or healthcare professional before making decisions regarding any medical condition, diagnosis, treatment, or medication.
            </p>
          </div>
          ...
          <div className="space-y-[20px]">
            ...
            <p className="txt-p">
              Customers may contact us to receive general wellness and nutrition guidance related to our products.
            </p>
            <p className="txt-p">
              Any consultation or guidance provided is intended solely for general wellness, nutrition, and lifestyle support and should not be considered medical advice, diagnosis, or treatment.

            </p>
            <p className="txt-p">
              Any recommendations or suggestions provided by PunchRaksha are based solely on the information voluntarily shared by the customer.
            </p>
            <p className="txt-p">
              The customer is solely responsible for deciding whether to follow or disregard any guidance, suggestions, or recommendations provided during consultation or communication with us.

            </p>
            <p className="txt-p">
              Customers are strongly advised to consult a qualified medical doctor or healthcare professional for any medical condition, diagnosis, treatment, emergency, or health concern.
          ...
          <div className="space-y-[20px]">
            ...
            <p className="txt-p">
              Any guidance, suggestions, or recommendations provided by
              PunchRaksha are optional in nature. The customer has full
              discretion to accept, reject, or discontinue any recommendation.
              The customer&apos;s decision regarding whether or not to follow
              any guidance remains entirely their own responsibility.
            </p>
            <p className="txt-p">
          ...
          <div className="space-y-[20px]">
            ...
            <ul className="list-disc pl-[20px] space-y-2.5 txt-p mb-4 ml-[6px] [&>li]:pl-[15px]">
              ...
              <li>Health outcomes resulting from the use or non-use of products, or from following or not following any guidance, suggestions, or recommendations provided by PunchRaksha.</li>
              <li>
            ...
            <p className="txt-p">
              PunchRaksha shall not be liable for any decision made by a
              customer based on consultations, conversations, messages,
              emails, phone calls, or other communications. Customers are
              solely responsible for their healthcare decisions and should
              always seek advice from a qualified medical doctor for any
