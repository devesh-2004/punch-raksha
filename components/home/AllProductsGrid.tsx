...
import { AllProductsGridClient } from "@/components/home/AllProductsGridClient";
...
export async function AllProductsGrid() {
  ...
  const products: ProductCardData[] = productDocs.map((p) => {
    ...
    return {
      ...
      imageAlt: p.featuredImageAlt || p.images?.[0]?.altText || p.name,
  ...
  return <AllProductsGridClient products={products} />;
}
