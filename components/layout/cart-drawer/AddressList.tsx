...
export function AddressList({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <div className="shrink-0 px-[15px] md:px-[30px] pb-6 flex flex-col gap-4">
        <div className="h-[1px] w-full bg-black/60" />
        <div className="flex items-center justify-center">
          <ButtonBase
            onClick={onAddNew}
            className="!block !flex-none !shrink-0 bg-white !text-primary border-primary !border-[1px] !rounded-[10px] !font-medium !px-[20px] !py-[15px] text-center hover:!bg-primary hover:!text-white transition-colors"
          >
            ADD NEW ADDRESS
          </ButtonBase>
        </div>
